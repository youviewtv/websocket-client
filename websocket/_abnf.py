...
__all__ = [
    'ABNF', 'CloseStatus', 'continuous_frame', 'frame_buffer',
]
...
VALID_CLOSE_STATUS = (
    ...
    CloseStatus.UNSUPPORTED_DATA_TYPE,
    CloseStatus.INVALID_PAYLOAD,
    CloseStatus.POLICY_VIOLATION,
    CloseStatus.MESSAGE_TOO_BIG,
    CloseStatus.INVALID_EXTENSION,
    CloseStatus.UNEXPECTED_CONDITION,
)
